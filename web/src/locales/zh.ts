export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      uploadDescription:
        '支持单次或批量上传。本地部署的单次上传文件总大小上限为 1GB，单次批量上传文件数不超过 32，单个账户不限文件数量。每次上传的总文件大小限制为 10MB，每个文件不得超过 10MB，每个账户最多可上传 128 个文件。严禁上传违禁文件。',
      chunk: '解析块',
      bulk: '批量',
      cancel: '取消',
      close: '关闭',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      chunkMethod: '切片方法',
      chunkMethodTip:
        '支持上传文件类型PDF、DOC、DOCX，对应内置方法Paper或者General',
      upload: '上传',
      english: '英文',
      chinese: '中文',
...
[在此处插入文本]`,
    ...
    search: {
      ...
      searchGreeting: '请输入关键词，精准检索所需知识？',
      profile: '隐藏个人资料',
      locale: '语言',
      embedCode: '嵌入代码',
      id: 'ID',
    ...
    admin: {
      ...
      invalidEmail: '请输入有效的手机号/邮箱地址！',
      passwordRequired: '请输入您的密码！',
      passwordMinLength: '密码长度必须超过8个字符。',
      ...
      importFileTips: '文件必须包含一个名为 <code>email</code> 的单一表头列。',
