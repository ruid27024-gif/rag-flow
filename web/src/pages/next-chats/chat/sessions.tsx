  ...
  if (!visible) {
    return (
      <aside
        className="
        w-[40px] shrink-0
        bg-[#F6FAFF] dark:bg-slate-950
        border-r border-sky-100/80 dark:border-slate-800
      ...
      >
        {conversationList.map((x) => {
          ...
          return (
            ...
            >
              <CardContent className="pl-[2em] py-2 flex justify-between items-center group gap-2">
