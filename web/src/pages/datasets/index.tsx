...
//   if (groupName === '管理员私有库') return '/1.png';
//   if (groupName === '全局参考库') return '/2.png';
//   return '/3.png';
// };
//   const getGroupCardClass = (groupName: string) => {
...
//             <div className="flex-1 min-h-0 overflow-y-auto">
//               <div className="flex flex-col gap-4 w-full px-8 pt-1">
//                 {Object.entries(groupedDatasets).map(([groupName, datasets]) => (
//   <div key={groupName} className="flex flex-col gap-4">
//     {/* 组名 */}
//     <div className="flex items-center gap-2 pl-3">
//       <img
//         src={getGroupIcon(groupName)}
//         alt=""
...
//     key={dataset.id}
//     showDatasetRenameModal={showDatasetRenameModal}
//     cardClassName={getGroupCardClass(groupName)}
//   />
// ))}
//     </div>
//   </div>
