...
export function SingleChatBox({
  ...
  //             <p
  //               className="
  //                 text-2xl sm:text-3xl font-medium mb-2 leading-tight
  //               "
  //               style={{
  //                 backgroundClip: 'text',
  //                 WebkitBackgroundClip: 'text',
  ...
  //             <p className="text-[#14b8a6] dark:text-[#2dd4bf] text-base sm:text-lg mb-6 leading-snug">
  //               左上方选择您的知识库😊
  //             </p>
        ...
        <div className="w-full pr-5">
          ...
          {!conversationId || derivedMessages.length === 1 ? (
            ...
            >
              ...
              <p className="text-[#14b8a6] dark:text-[#2dd4bf] text-base sm:text-lg mb-3 leading-snug">
                左上方选择您的知识库😊
              </p>
