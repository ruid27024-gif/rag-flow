...
export default {
  ...
  create_my_group: `${api_host}/group/my_group/create`,
  // user_group
  ...
  // user
  // admin config
  get_admin_dialog_config: `${api_host}/dialog/admin/config/get`,
  set_admin_dialog_config: `${api_host}/dialog/admin/config/set`,
